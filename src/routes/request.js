...
// POST --> Means user will insert or send data into db so we have to check all data and user info
// GET --> we have to fetch data from db so make sure send only allowed data not all
